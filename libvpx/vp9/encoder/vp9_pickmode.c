...
static void model_rd_for_sb_y_large(VP9_COMP *cpi, BLOCK_SIZE bsize,
  ...
  unsigned int sse8x8[64]; // -C99 = {0};
  int sum8x8[64]; // -C99 = {0};
  unsigned int var8x8[64]; // -C99 = {0};
  TX_SIZE tx_size;
  int i, k;

  memset(sse8x8, 0, sizeof(sse8x8));
  memset(sum8x8, 0, sizeof(sum8x8));
  memset(var8x8, 0, sizeof(var8x8));
  ...
  *sse_y = sse;
  ...
  {
    unsigned int sse16x16[16]; // -C99 = {0};
    int sum16x16[16]; // -C99 = {0};
    unsigned int var16x16[16]; // -C99 = {0};
    const int num16x16 = num8x8 >> 2;

    unsigned int sse32x32[4]; // -C99 = {0};
    int sum32x32[4]; // -C99 = {0};
    unsigned int var32x32[4]; // -C99 = {0};
    ...
    memset(sse16x16, 0, sizeof(sse16x16));
    memset(sum16x16, 0, sizeof(sum16x16));
    memset(var16x16, 0, sizeof(var16x16));
    memset(sse32x32, 0, sizeof(sse32x32));
    memset(sum32x32, 0, sizeof(sum32x32));
    memset(var32x32, 0, sizeof(var32x32));
...
void vp9_pick_inter_mode(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  int const_motion[MAX_REF_FRAMES] = { 0, 0, 0, 0 };  // -C99
  ...
  int ref_frame_cost[MAX_REF_FRAMES];
  int svc_force_zero_mode[3] = {0, 0, 0}; // -C99
